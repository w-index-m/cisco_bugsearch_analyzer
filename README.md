...
- **Catalyst 9300 / Cisco IOS XEのみ**: `PSIRT_CLIENT_ID`/`PSIRT_CLIENT_SECRET`（Cisco API Consoleで取得）を設定していれば、Cisco公式セキュリティアドバイザリ（PSIRT openVuln API）もNVD検索結果に自動合流
